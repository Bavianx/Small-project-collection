...
A command-line expense tracking application built in Python. Track your spending across multiple categories, view detailed breakdowns, and manage your finances effectively.

## Features 

- **Add Expenses**: Record expenses with category, amount, description, and date
- **View by Category**: See all expenses within a specific category
